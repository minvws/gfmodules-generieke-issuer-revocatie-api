...
curl -f http://secrets/revocation-service/revocation-service.crt -o $SECRETS_DIR/revocation-service.crt
curl -f http://secrets/revocation-service/revocation-service.key -o $SECRETS_DIR/revocation-service.key
