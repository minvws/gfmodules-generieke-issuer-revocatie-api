...
from app.db.repositories import RepositoryBase, TRepositoryBase
...
class DbSession:
    ...
    def refresh(self, entry: Base) -> None:
        """
        Refresh the session, clearing any cached objects and reloading them from the database
        """
        self._retry(self.session.refresh, entry)
