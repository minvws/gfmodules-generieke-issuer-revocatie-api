...
class ConfigUvicorn(BaseModel):
    ...
    port: int = Field(default=8525, gt=0, lt=65535)
...
class ConfigCredential(BaseModel):
    private_key_jwk: str | None = Field(default=None, description="JWK of the private key used for signing credentials")
    did: str | None = Field(default=None, description="DID of the credential")
    bitstring_size_kb: int = Field(default=16, ge=16, description="Size of the bitstring in KB")
